...
const Checkout = () => {
    ...
    console.log("linea 17 carrito", carrito)
    ...
    const manejadorFormulario =(e) => {
      ...
      console.log("linea 46 orden", orden)
    ...
    <div>
        ...
        <form onSubmit={manejadorFormulario}>
          ...
          <div>
            ...
            <input type="text" onChange={(e)=>setEmailConfirm(e.target.value)} value={emailConfirm}/>
          </div>
            {
              <p>{error}</p>
            }
          ...
          {
              <strong>Gracias por tu compra, número de orden es: {ordenId}</strong>
          }
        </form>
    </div>
  )
